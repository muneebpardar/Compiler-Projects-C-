// ============================================================================
// INTCALC COMPILER - Complete Implementation
// Author: Compiler Construction Project
// Description: Full compiler for integer arithmetic language (addition/subtraction)
    ...
    vector<Token> tokenize() {
        ...
        while (currentChar != '\0') {
            ...
            // Operators and punctuation
                ...
                // Invalid character
                tokens.push_back(Token(TokenType::INVALID, string(1, currentChar), 0, line, startCol));
                advance();
            }
        }
...
private:
    ...
    // Expression parsing with left-to-right evaluation for + and -
    ...
    unique_ptr<ASTNode> parsePrimary() {
        ...
        error("Expected expression (number, identifier, or parenthesized expression)");
    ...
    unique_ptr<ASTNode> parseStatement() {
        ...
        if (tok.type == TokenType::PRINT) {
            ...
            error("Expected statement (assignment or print)");
            advance();
            return nullptr;
        }
    }
...
public:
    ...
    int get(const string& name) {
        ...
        if (!it->second.initialized) {
            throw runtime_error("Variable '" + name + "' used before initialization");
        }
...
public:
    ...
    string generate(ProgramNode* program) {
        ...
        asmCode << "; IntCalc Compiler - Generated Assembly Code (x86-64)\n\n";
...
private:
    ...
    void printHeader() {
        cout << "\n";
        cout << string(70, '=') << "\n";
        cout << "    INTCALC COMPILER - Full Compilation Pipeline\n";
        cout << "    Integer Arithmetic Language (Addition/Subtraction)\n";
        cout << "    Version: 1.0\n";
        cout << string(70, '=') << "\n";
    }
...
void runInteractiveMode() {
    while (true) {
        cout << "\n=== INTCALC COMPILER - INTERACTIVE MODE ===\n";
        cout << "\nSelect example program:\n";
        cout << "1. Simple arithmetic\n";
        cout << "2. Multiple operations\n";
        cout << "3. Complex expression\n";
        cout << "4. Variable chain\n";
        ...
        if (choice == 6) {
            cout << "\nExiting IntCalc Compiler. Goodbye!\n";
            break;
        }
...
void runTestSuite() {
    cout << "\n=== INTCALC COMPILER TEST SUITE ===\n";
    cout << string(70, '=') << "\n";

    vector<pair<string, string>> tests = {
        {"Test 1: Basic Assignment", "x = 5;\nprint x;"},
        {"Test 2: Addition", "x = 3 + 4;\nprint x;"},
        {"Test 3: Subtraction", "x = 10 - 3;\nprint x;"},
        {"Test 4: Multiple Operations", "x = 5 + 3 - 2;\nprint x;"},
        {"Test 5: Variable Usage", "a = 10;\nb = a + 5;\nprint b;"},
        {"Test 6: Complex Chain", "x = 5;\ny = x + 10;\nz = y - 3;\nprint z;"},
        {"Test 7: Negative Numbers", "x = -5;\ny = x + 10;\nprint y;"},
        {"Test 8: Long Expression", "result = 100 - 25 + 10 - 5 + 20;\nprint result;"}
    };
    ...
    for (const auto& test : tests) {
        ...
        try {
            ...
            if (success) {
                ...
                Interpreter interpreter(compiler.symbolTable);
                interpreter.execute(compiler.ast.get());
                passed++;
            } else {
...
To compile this compiler:
    g++ -std=c++17 -O2 -o intcalc_compiler intcalc_compiler.cpp

To run:
    ./intcalc_compiler                    # Interactive mode
    ./intcalc_compiler program.ic         # Compile a file
    ./intcalc_compiler --test             # Run test suite
    ./intcalc_compiler --help             # Show help

LANGUAGE FEATURES:
==================
1. Variable assignment: x = 10;
2. Arithmetic operations: + (addition), - (subtraction)
3. Print statement: print x;
4. Comments: // single line comments
5. Integer literals (including negative numbers)
6. Expressions with multiple operations (left-to-right evaluation)
7. Parenthesized expressions for grouping
